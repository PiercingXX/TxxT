 ...
 * AMOLED black (docs/DESIGN.md §"Conversation list").
 *
 ...
 * presenter's view state to an inflated `item_conversation.xml`.
 */
class ConversationListAdapter(
    private val bindRow: (View, ConversationRow) -> Unit = ::defaultBindRow,
    ...
    companion object {
         ...
         * `"n new"` otherwise; emphasis from the white-opacity ramp, never hue).
         */
